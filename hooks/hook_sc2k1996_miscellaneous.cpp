...
#define MISCHOOK_DEBUG_SPRITE 128
...
static void ReloadDefaultTileSet() {
	...
	ReloadSpriteDataArchive(TILEDAT_DEFS_SPECIAL);
	ReloadSpriteDataArchive(TILEDAT_DEFS_LARGE);
	ReloadSpriteDataArchive(TILEDAT_DEFS_SMALLMED);
...
void InstallMiscHooks_SC2K1996(void) {
	...
	*(BYTE*)0x44DC4F = 10;
	...
	NEWJMP((LPVOID)0x4029B4, Hook_LoadSpriteDataArchive);

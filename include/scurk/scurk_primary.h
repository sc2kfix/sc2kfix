...
SCURKPRIMARY_GAMECALL_MAIN(0x4132F4, int, __cdecl, gScurkMessage, DWORD, DWORD, DWORD)
SCURKPRIMARY_GAMECALL_MAIN(0x41344C, int, __cdecl, gScurkMessage_Str, char *, DWORD, DWORD)
SCURKPRIMARY_GAMECALL_MAIN(0x41366C, BC45Xstring *, __cdecl, gScurkLoadString, BC45Xstring *, DWORD)
...
SCURKPRIMARY_GAMECALL_MAIN(0x41387C, void, __stdcall, BeginWaitCursor)
SCURKPRIMARY_GAMECALL_MAIN(0x413894, void, __stdcall, EndWaitCursor)
SCURKPRIMARY_GAMECALL_MAIN(0x4138AC, void, __cdecl, gBeginWaitWindow, int, char *, TBC45XModule *)
SCURKPRIMARY_GAMECALL_MAIN(0x4139B4, void, __stdcall, gUpdateWaitWindow)
SCURKPRIMARY_GAMECALL_MAIN(0x4139F4, void, __stdcall, gEndWaitWindow)
...
SCURKPRIMARY_GAMECALL_MAIN(0x43F390, void, __cdecl, EditWindow_mDoCurrentPatternDib, winscurkEditWindow *)
...
SCURKPRIMARY_GAMECALL_MAIN(0x44A0BC, void, __cdecl, winscurkMDIClient_mReadFromMIFFile, winscurkMDIClient *, cEditableTileSet *, const char *)
SCURKPRIMARY_GAMECALL_MAIN(0x44A180, void, __cdecl, winscurkMDIClient_mReadFromTILFile, winscurkMDIClient *, cEditableTileSet *, const char *)
SCURKPRIMARY_GAMECALL_MAIN(0x44A290, OPENFILENAMEA *, __cdecl, winscurkMDIClient_mGetOpenFileName, winscurkMDIClient *)
SCURKPRIMARY_GAMECALL_MAIN(0x44A4B0, char *, __cdecl, winscurkMDIClient_mAttachMif, winscurkMDIClient *, char *)
SCURKPRIMARY_GAMECALL_MAIN(0x44A9C8, void, __cdecl, winscurkMDIClient_CmFileSaveWorking, winscurkMDIClient *)
SCURKPRIMARY_GAMECALL_MAIN(0x457AF4, TBC45XPalette *, __cdecl, winscurkApp_GetPalette, winscurkApp *)
SCURKPRIMARY_GAMECALL_MAIN(0x457E28, char *, __cdecl, winscurkApp_mGetMiffPath, winscurkApp *)
SCURKPRIMARY_GAMECALL_MAIN(0x457E70, void, __cdecl, winscurkApp_mSetMiffPath, winscurkApp *, char *)
...
SCURKPRIMARY_GAMECALL_MAIN(0x459F04, int, __cdecl, winscurkApp_mGetFileType, winscurkApp *, char *)

// BC and WinAPI
SCURKPRIMARY_GAMECALL_MAIN(0x45F80F, void, __cdecl, BCDC_SelectObjectPalette, TBC45XDC *, TBC45XPalette *, int)
SCURKPRIMARY_GAMECALL_MAIN(0x466C85, TBC45XPalette *, __cdecl, BCPalette_Construct, TBC45XPalette *, PALETTEENTRY *, int)
...
SCURKPRIMARY_GAMECALL_MAIN(0x46A3F1, void, __cdecl, BCWindow_EvLButtonDown, TBC45XWindow *, DWORD, TBC45XPoint *)
SCURKPRIMARY_GAMECALL_MAIN(0x46B108, void, __cdecl, BCWindow_SetCursor, TBC45XParWindow *, TBC45XModule *, const char *)
SCURKPRIMARY_GAMECALL_MAIN(0x46B339, int, __cdecl, BCWindow_MessageBox, TBC45XWindow *, const char *, const char *, DWORD)
...
SCURKPRIMARY_GAMECALL_MAIN(0x46FFCD, void, __cdecl, Dib_Destruct, TBC45XDib *, char)
SCURKPRIMARY_GAMECALL_MAIN(0x470D34, TBC45XDib *, __cdecl, Dib_Construct_Res, TBC45XDib *, HINSTANCE, int)
SCURKPRIMARY_GAMECALL_MAIN(0x4711BC, TBC45XDib *, __cdecl, Dib_Construct_Dimens, TBC45XDib *, LONG, LONG, DWORD, WORD)
...
SCURKPRIMARY_GAMEOFF(int,			gSaveSucceeded,			0x4A5E40)

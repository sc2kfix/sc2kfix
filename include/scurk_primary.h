...
SCURKPRIMARY_GAMECALL_MAIN(0x441CB8, void, __cdecl, winscurkPlaceWindow_HideTools, DWORD *)
...
SCURKPRIMARY_GAMECALL_MAIN(0x46AE30, LRESULT, __cdecl, BCWindow_SendMessageA, DWORD *, UINT msg, WPARAM wParam, LPARAM lParam)
...
SCURKPRIMARY_GAMECALL_MAIN(0x4745B6, void, __cdecl, BCFrameWindow_EvSize, DWORD *, unsigned int, TBC45XSize *)

...
SCURKPRIMARY_GAMECALL_MAIN(0x430C34, __int16, __cdecl, FlipShortBytes, __int16)
SCURKPRIMARY_GAMECALL_MAIN(0x430C84, int, __cdecl, FlipLongBytePortions, int)
...
SCURKPRIMARY_GAMECALL_MAIN(0x46AE30, LRESULT, __cdecl, BCWindow_SendMessageA, TBC45XParWindow *, UINT msg, WPARAM wParam, LPARAM lParam)
...
SCURKPRIMARY_GAMECALL_MAIN(0x4745B6, void, __cdecl, BCFrameWindow_EvSize, TBC45XParFrameWindow *, unsigned int, TBC45XSize *)

...
SCURKPRIMARY_GAMECALL_MAIN(0x440F80, void, __cdecl, winscurkPlaceWindow_ClearCurrentTool, winscurkPlaceWindow *)
SCURKPRIMARY_GAMECALL_MAIN(0x441CB8, void, __cdecl, winscurkPlaceWindow_HideTools, winscurkPlaceWindow *)
...
SCURKPRIMARY_GAMECALL_MAIN(0x469C64, LRESULT, __cdecl, BCWindow_HandleMessage, TBC45XWindow *, unsigned int msg, WPARAM wParam, LPARAM lParam)
SCURKPRIMARY_GAMECALL_MAIN(0x46AE30, LRESULT, __cdecl, BCWindow_SendMessageA, TBC45XWindow *, UINT msg, WPARAM wParam, LPARAM lParam)
SCURKPRIMARY_GAMECALL_MAIN(0x46B108, void, __cdecl, BCWindow_SetCursor, TBC45XWindow *, TBC45XModule *, const char *)
SCURKPRIMARY_GAMECALL_MAIN(0x46F9DB, void, __cdecl, BCDialog_SetupWindow, TBC45XDialog *)
SCURKPRIMARY_GAMECALL_MAIN(0x46FABD, void, __cdecl, BCDialog_SetCaption, TBC45XDialog *, char *)
SCURKPRIMARY_GAMECALL_MAIN(0x46FB35, void, __cdecl, BCDialog_EvClose, TBC45XDialog *)
SCURKPRIMARY_GAMECALL_MAIN(0x4745B6, void, __cdecl, BCFrameWindow_EvSize, TBC45XFrameWindow *, unsigned int, TBC45XSize *)
SCURKPRIMARY_GAMECALL_MAIN(0x476475, int, __cdecl, BCListBox_GetSelIndex, TBC45XListBox *)
SCURKPRIMARY_GAMECALL_MAIN(0x477A62, LRESULT, __cdecl, BCListBox_GetString, TBC45XListBox *, char *, int)
SCURKPRIMARY_GAMECALL_MAIN(0x477A9B, int, __cdecl, BCListBox_SetItemData, TBC45XListBox *, int, unsigned int)
SCURKPRIMARY_GAMECALL_MAIN(0x477B26, int, __cdecl, BCListBox_AddString, TBC45XListBox *, const char *)
...
SCURKPRIMARY_GAMEOFF(DWORD,		gReadyToGo,				0x4A6668)

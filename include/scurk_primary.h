...
// Program funcs
SCURKPRIMARY_GAMECALL_MAIN(0x41083C, void, __cdecl, PlaceTileListDlg_DrawTile, DWORD *, DRAWITEMSTRUCT *)
SCURKPRIMARY_GAMECALL_MAIN(0x410A80, void, __cdecl, PlaceTileListDlg_ChangeHiLight, DWORD *, DRAWITEMSTRUCT *)
SCURKPRIMARY_GAMECALL_MAIN(0x4132EC, void, __cdecl, DebugOut, const char *, ...)
SCURKPRIMARY_GAMECALL_MAIN(0x414D78, char *, __cdecl, EditableTileSet_GetLongName, DWORD *, int)
...
SCURKPRIMARY_GAMECALL_MAIN(0x469C64, LRESULT, __cdecl, BCWindow_HandleMessage, DWORD *, unsigned int msg, WPARAM wParam, LPARAM lParam)
SCURKPRIMARY_GAMECALL_MAIN(0x46B108, void, __cdecl, BCWindow_SetCursor, DWORD *, DWORD *, const char *)
SCURKPRIMARY_GAMECALL_MAIN(0x46F9DB, void, __cdecl, BCDialog_SetupWindow, DWORD *)
SCURKPRIMARY_GAMECALL_MAIN(0x46FABD, void, __cdecl, BCDialog_SetCaption, DWORD *, char *)
SCURKPRIMARY_GAMECALL_MAIN(0x46FB35, void, __cdecl, BCDialog_EvClose, DWORD *)
SCURKPRIMARY_GAMECALL_MAIN(0x476475, int, __cdecl, BCListBox_GetSelIndex, DWORD *)
SCURKPRIMARY_GAMECALL_MAIN(0x477A62, LRESULT, __cdecl, BCListBox_GetString, DWORD *, char *, int)
SCURKPRIMARY_GAMECALL_MAIN(0x477A9B, int, __cdecl, BCListBox_SetItemData, DWORD *, int, unsigned int)
SCURKPRIMARY_GAMECALL_MAIN(0x477B26, int, __cdecl, BCListBox_AddString, DWORD *, const char *)

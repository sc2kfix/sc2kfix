...
* Hotkeys can be mapped to perform different actions.
...
4. Play the game! On the first run of a new install, the game will prompt you for a default mayor name, as well as default mod settings. This simulates the original SimCity 2000 installer and sets up the sc2kfix experience.
...
## Known issues
* WARNING: MIDI playback support on Wine/Proton is unpredictable. Native Linux installations of FluidSynth or TiMIDity++ may result in playback errors, and using Windows builds of FluidSynth in Wine/Proton can occasionally cause freezes on older distros. We recommend ensuring your distro and Wine/Proton are up to date if you experience crashes with MIDI playback via FluidSynth, or using MP3 playback instead.
